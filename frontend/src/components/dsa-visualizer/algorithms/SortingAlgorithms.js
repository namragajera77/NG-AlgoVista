...
// Export with simplified names for backward compatibility
export const bubbleSort = bubbleSortWithSteps;
export const selectionSort = selectionSortWithSteps;
export const insertionSort = insertionSortWithSteps;
export const mergeSort = mergeSortWithSteps;
export const quickSort = quickSortWithSteps;
